...
MariaDbAccessor::MariaDbAccessor()
{
}
...
void MariaDbAccessor::GetDefaultConnStr(SQLTCHAR DefConnStr[Global::MAX_PARAM_LENGTH])
{
...
int MariaDbAccessor::GetNumOfRecords(SQLTCHAR* TableName, SQLTCHAR StateMsg[10], SQLTCHAR* Msg, SQLSMALLINT MsgLen)
{
...
SQLRETURN MariaDbAccessor::GetTables(SQLTCHAR* OutJson, int SizeOfOutJson, SQLTCHAR StateMsg[10], SQLTCHAR* Msg, SQLSMALLINT MsgLen)
{
	SQLRETURN Ret = 0;
...
int MariaDbAccessor::GetColumnInfoByTableName(SQLTCHAR* TableName,
...
int MariaDbAccessor::GetRecordsByTableName(SQLTCHAR* TableName,
	int NumOfCols,
...
int MariaDbAccessor::ConvertAttrType(SQLTCHAR InAttr[Global::COLUMNTYPE_LENGTH], SQLTCHAR OutAttr[Global::COLUMNTYPE_LENGTH])
{
...
void MariaDbAccessor::SqlEncoding(SQLTCHAR* InSql, SQLTCHAR* OutSql, int Type)
{
